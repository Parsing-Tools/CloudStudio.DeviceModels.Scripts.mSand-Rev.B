...
# Parsing Script – mSand - Rev. B

This **Parsing** script is designed for the **mSand** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – mSand Rev. B

Este script de **Parsing** está diseñado para el modelo **mSand** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
